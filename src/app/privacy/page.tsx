...
export default function PrivacyPage() {
  return (
    <div className="privacyp ml-5">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Nobelpriset.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Nobelpriset, accessible from{" "}
            <a
              href="https://www.datanom.ax/~63832/Nobelpriset/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.datanom.ax/~63832/Nobelpriset/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: vistrac.info@gmail.com</li>
      </ul>
    </div>
  );
}
